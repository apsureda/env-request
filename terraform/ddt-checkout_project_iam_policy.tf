...
resource "google_project_iam_binding" "ddt-checkout-dev_cloudbuild_builds_editor" {
  project = "${google_project.ddt-checkout-dev.project_id}"
...
resource "google_project_iam_binding" "ddt-checkout-test_cloudbuild_builds_editor" {
  project = "${google_project.ddt-checkout-test.project_id}"
  role    = "roles/cloudbuild.builds.editor"
...
resource "google_project_iam_binding" "ddt-checkout-prod_cloudbuild_builds_editor" {
  project = "${google_project.ddt-checkout-prod.project_id}"
  role    = "roles/cloudbuild.builds.editor"
