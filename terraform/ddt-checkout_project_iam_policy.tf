...
resource "google_project_iam_binding" "ddt-checkout-dev_appengine_appAdmin" {
  ...
  members = [
        "group:gcp-ddt-ops@apszaz.com",    "group:gcp-ddt-mamagers@apszaz.com",    "serviceAccount:${google_project.ddt-checkout-dev.number}@cloudbuild.gserviceaccount.com",  ]
}
resource "google_project_iam_binding" "ddt-checkout-test_appengine_codeViewer" {
  ...
  members = [
        "group:gcp-ddt-developers@apszaz.com",    "group:gcp-ddt-qa@apszaz.com",  ]
}
